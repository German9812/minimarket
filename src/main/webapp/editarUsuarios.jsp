				...
				<div class="full-width panel mdl-shadow--2dp">
					...
					<div class="full-width panel-content">
						<form action="SvEditarUsu" method="POST">
							<div class="mdl-grid">
								...
								<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										...
										<label class="mdl-textfield__label" for="username"><%=usu.getNombreUsuario()%></label>
							...
							<p class="text-center">
                                                            <button type="submit" class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" id="agregarusuario">
									<i class="zmdi zmdi-plus"></i>
								</button>
								<div class="mdl-tooltip" for="agregarusuario">EDITAR</div>
							</p>
						</form>
					</div>
				</div>
